...
% fprintf(1, '\n');
textUpdate = ['Reading Intan Technologies RHD2000 Data File, Version ', ...
    num2str(data_file_main_version_number), num2str(data_file_secondary_version_number)];
ReadoutUpdate(handles.w.drta,textUpdate)
...
if (data_present)
    ...
    if (num_gaps == 0)
        ...
        clear textUpdate
        textUpdate = [ ...
            'Warning: ',num2str(num_gaps), ...
            ' gaps in timestamp data found.', ...
...
%                             pffft=1;
        ...
        clear textUpdate
        textUpdate = ['Found',full_trials,' full trials...'];
        ReadoutUpdate(handles.w.drta,textUpdate)
...
%         fprintf(1, 'Found %d inter trials ...\n',draq_d.noTrials-full_trials);
    ...
    case 2
        ...
        clear textUpdate
        textUpdate = ['Found',full_truals,' full trials...'];
        ReadoutUpdate(handles.w.drta,textUpdate)
        %Find empty trials
        last_trial=draq_d.noTrials;
        ...
        clear textUpdate
        textUpdate = ['Found ', num2str(draq_d.noTrials-full_trials), ...
            'inter trials ...'];
        ReadoutUpdate(handles.w.drta,textUpdate)
    case 3
        %dropcnsampler
...
%                             plot(digital_input_ns(full_trial_start(draq_d.noTrials):full_trial_end(draq_d.noTrials)))
        ...
        clear textUpdate
        textUpdate = ['Found ', num2str(full_trials), ...
            'full trials ...'];
        ReadoutUpdate(handles.w.drta,textUpdate)
    case 4
        ...
        clear textUpdate
        textUpdate = 'Founding inter trials ...';
        ReadoutUpdate(handles.w.drta,textUpdate)
        %Empty trial before the first trial
        if trials_to_sort(1,1)>draq_p.sec_per_trigger+draq_p.sec_before_trigger
            draq_d.noTrials=draq_d.noTrials+1;
