...
if app.Flags.SelectCh == 1
    ...
    NumCh = app.drta_handles.draq_p.no_spike_ch;
end
...
switch ProcessType
    ...
    case 3 % create events
        ...
        start_ii=1;
        end_ii=app.drta_handles.draq_p.sec_per_trigger*app.drta_handles.draq_p.ActualRate;
        ...
        if ~isempty(find(shift_dropc_nsampler>=1,1,'first'))
            ...
            app.drta_handles.draq_d.delta_ii_odor1(trialNo)=delta_ii_odor1;
            app.drta_handles.draq_d.delta_ii_odor12(trialNo)=delta_ii_odor12;
            app.drta_handles.draq_d.delta_ii_odor2(trialNo)=delta_ii_odor2;
            ...
            if (~isempty(ii_first2))&(~isempty(ii_first4))
                ...
                %OdorOn
                app.drta_handles.draq_d.noEvents=app.drta_handles.draq_d.noEvents+1;
                app.drta_handles.draq_d.events(app.drta_handles.draq_d.noEvents)=app.drta_handles.draq_d.t_trial(trialNo)+ii_odor_on/app.drta_handles.draq_p.ActualRate;
                ...
                delta_RA=0.5*app.drta_handles.draq_p.ActualRate;
    ...
    case 4 % setup for block number
        ...
        textUpdate = sprintf('Delta odor 1 = %d sec', mean(app.drta_handles.draq_d.delta_ii_odor1)/app.drta_handles.draq_p.ActualRate);
        ReadoutUpdate(app,textUpdate);
        textUpdate = sprintf('Delta odor 12 = %d sec', mean(app.drta_handles.draq_d.delta_ii_odor12)/app.drta_handles.draq_p.ActualRate);
        ReadoutUpdate(app,textUpdate);
        textUpdate = spirntf('Delta odor 2 = %d sec', mean(app.drta_handles.draq_d.delta_ii_odor2)/app.drta_handles.draq_p.ActualRate);
        ReadoutUpdate(app,textUpdate);
end
