...
switch ProcessType
    ...
    case 3 % create events
        ...
        start_ii=(app.drta_Data.draq_p.sec_before_trigger-7)*app.drta_Data.draq_p.ActualRate+1;
        end_ii=(app.drta_Data.draq_p.sec_before_trigger+3)*app.drta_Data.draq_p.ActualRate;

        if ~isempty(find(shiftdata>=1,1,'first'))

            if sum(shiftdata(start_ii:end_ii)>=1)<2*app.drta_Data.draq_p.ActualRate
                %This is a short
                ...
                found_Short=(sum(shiftdata==2)>0.05*app.drta_Data.draq_p.ActualRate)||(sum(shiftdata==4)>0.05*app.drta_Data.draq_p.ActualRate);
                ...
                %
                if (sum(shiftdata(t_start:end_ii)==18)>2*app.drta_Data.draq_p.ActualRate) %Note that I have relaxed this for _hf
                ...
                if sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==8)>0.01*app.drta_Data.draq_p.ActualRate
                ...
                if sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==10)>0.01*app.drta_Data.draq_p.ActualRate
                ...
                if sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==12)>0.01*app.drta_Data.draq_p.ActualRate
                ...
                if sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==14)>0.01*app.drta_Data.draq_p.ActualRate
                ...
                if (sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==2)>0.01*app.drta_Data.draq_p.ActualRate)||...
                        (sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==4)>0.01*app.drta_Data.draq_p.ActualRate)
                    ...
                    if (found_odor_on==1)
                        ...
                        app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+odor_on/app.drta_Data.draq_p.ActualRate;
                        app.drta_Data.draq_d.eventType(app.drta_Data.draq_d.noEvents)=16;
                        app.drta_Data.draq_d.nEvPerType(13)=app.drta_Data.draq_d.nEvPerType(16)+1;
                    end
                ...
                if sum(shiftdata(t_start:t_start+6*app.drta_Data.draq_p.ActualRate)==16)>0.01*app.drta_Data.draq_p.ActualRate
