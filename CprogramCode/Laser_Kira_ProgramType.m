...
switch ProcessType
    ...
    case 3 % create events
        ...
        %             plot(laser)
        %
        start_ii=(app.drta_handles.draq_p.sec_before_trigger-6)*app.drta_handles.draq_p.ActualRate+1;
        end_ii=(app.drta_handles.draq_p.sec_before_trigger+2)*app.drta_handles.draq_p.ActualRate;

        if ~isempty(find(shiftdata>=1,1,'first'))

            if sum(shiftdata(start_ii:end_ii)>=1)<3*app.drta_handles.draq_p.ActualRate
                %This is a short
                ...
                if exist('t_start')~=0
                    ...
                    if (sum(shiftdata(t_start:end_ii)==18)>2.4*app.drta_handles.draq_p.ActualRate)&foundEvent...
                        ...
                        %on?
                        laser_on_fraction=sum(laser(oo_ii:oo_ii+app.drta_handles.draq_p.ActualRate)>1.5)/app.drta_handles.draq_p.ActualRate;
                    ...
                    if sum(shiftdata(t_start:t_start+6*app.drta_handles.draq_p.ActualRate)==8)>0.05*app.drta_handles.draq_p.ActualRate
                    ...
                    if sum(shiftdata(t_start:t_start+6*app.drta_handles.draq_p.ActualRate)==10)>0.05*app.drta_handles.draq_p.ActualRate
                    ...
                    if sum(shiftdata(t_start:t_start+6*app.drta_handles.draq_p.ActualRate)==12)>0.05*app.drta_handles.draq_p.ActualRate
                    ...
                    if sum(shiftdata(t_start:t_start+6*app.drta_handles.draq_p.ActualRate)==14)>0.05*app.drta_handles.draq_p.ActualRate
                    ...
                    if sum(shiftdata(t_start:t_start+6*app.drta_handles.draq_p.ActualRate)==16)>0.02*app.drta_handles.draq_p.ActualRate
                    ...
                    if laser_on==1
                        ...
                        app.drta_handles.draq_d.events(app.drta_handles.draq_d.noEvents)=app.drta_handles.draq_d.t_trial(trialNo)+odor_on/app.drta_handles.draq_p.ActualRate;
                        app.drta_handles.draq_d.eventType(app.drta_handles.draq_d.noEvents)=16;
                        app.drta_handles.draq_d.nEvPerType(15)=app.drta_handles.draq_d.nEvPerType(16)+1;
                    end
