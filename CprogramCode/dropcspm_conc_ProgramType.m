...
switch ProcessType
    case 1 % generates labels
        app.drta_Data.draq_d.nEvPerType=zeros(1,23);
        app.drta_Data.draq_d.nEventTypes=23;
        app.drta_Data.draq_d.eventlabels=cell(1,23);
        ...
        app.drta_Data.draq_d.eventlabels{16}='Hi Od1'; %Highest concentration
        app.drta_Data.draq_d.eventlabels{17}='Hi Od2';
        app.drta_Data.draq_d.eventlabels{18}='Hi Od3';
        app.drta_Data.draq_d.eventlabels{19}='Low Od4';
        app.drta_Data.draq_d.eventlabels{20}='Low Od5';
        app.drta_Data.draq_d.eventlabels{21}='Low Od6'; %Lowest concentration
        app.drta_Data.draq_d.eventlabels{22}='Short';
        app.drta_Data.draq_d.eventlabels{23}='Inter';
    case 2 % trial exclusion
        ...
        %             firstFV=find(shift_dropc_nsampler==1,1,'first')/app.drta_Data.draq_p.ActualRate;
        %
    ...
    case 3 % create events
        ...
        if ~isempty(find(shift_dropc_nsampler>=1,1,'first'))
            ...
            if length(find(shift_dropc_nsampler>=1))<3*app.drta_Data.draq_p.ActualRate
                %This is a short
                ...
                app.drta_Data.draq_d.eventType(app.drta_Data.draq_d.noEvents)=22;
                app.drta_Data.draq_d.nEvPerType(22)=app.drta_Data.draq_d.nEvPerType(22)+1;
            else
                %Find trial start time (event 1)
                %Note: This is the same as FINAL_VALVE


                if sum(shift_dropc_nsampler==1)>0.9*app.drta_Data.draq_p.ActualRate
                    t_start=find(shift_dropc_nsampler==1,1,'first');
                    app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                    app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+t_start/app.drta_Data.draq_p.ActualRate;
                ...
                if exist('t_start')~=0
                    ...
                    if (sum((shift_dropc_nsampler(t_start:end)>=2)&(shift_dropc_nsampler(t_start:end)<=7))>2.4*app.drta_Data.draq_p.ActualRate)&...
                    ...
                    if (found_odor_on==1)
                        ...
                        if sum(shift_dropc_nsampler==8)>0.05*app.drta_Data.draq_p.ActualRate
                            ...
                            %HitE (event 4)
                            app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                            app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+hits/app.drta_Data.draq_p.ActualRate;
                        ...
                        if sum(shift_dropc_nsampler==10)>0.05*app.drta_Data.draq_p.ActualRate
                            ...
                            %MissE
                            app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                            app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+miss/app.drta_Data.draq_p.ActualRate;
                        ...
                        if sum(shift_dropc_nsampler==12)>0.05*app.drta_Data.draq_p.ActualRate
                            ...
                            %CRE (event 10)
                            app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                            app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+crej/app.drta_Data.draq_p.ActualRate;
                        ...
                        if sum(shift_dropc_nsampler(t_start:end)==14)>0.05*app.drta_Data.draq_p.ActualRate
                            ...
                            %FAE
                            app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                            app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+false_alarm/app.drta_Data.draq_p.ActualRate;
                        ...
                        if sum(shift_dropc_nsampler==32)>0.02*app.drta_Data.draq_p.ActualRate
                        ...
                        if ~isempty(this_odor)
                            ...
                            app.drta_Data.draq_d.eventType(app.drta_Data.draq_d.noEvents)=15+this_odor_evNo-1;
                            app.drta_Data.draq_d.nEvPerType(15+this_odor_evNo-1)=app.drta_Data.draq_d.nEvPerType(15+this_odor_evNo-1)+1;
                        end
                    end
                    ...
                    app.drta_Data.draq_d.noEvents=app.drta_Data.draq_d.noEvents+1;
                    app.drta_Data.draq_d.events(app.drta_Data.draq_d.noEvents)=app.drta_Data.draq_d.t_trial(trialNo)+(length(shift_dropc_nsampler)/3)/app.drta_Data.draq_p.ActualRate;
                    app.drta_Data.draq_d.eventType(app.drta_Data.draq_d.noEvents)=23;
                    app.drta_Data.draq_d.nEvPerType(23)=app.drta_Data.draq_d.nEvPerType(23)+1;
                end
            end
